...
#include "LESS_KAT_548_137.h" // Test Vectors
...
int main(void)
{
    ...
    //*************************************************
        ...
        if(memcmp(sm, TVEC_IN_SM_SIGN, 6829)) { printf("ERROR: SM mismatch\n"); }
    ...
    //*************************************************
        ...
        #endif /* TEST_KEY */
        #if TEST_SIGN == 0 
          memcpy(sm, TVEC_IN_SM_SIGN, 6829);
        #endif /* TEST_SIGN */
        
        crypto_sign_open(m1, &mlen1, sm, 6829, pk);
