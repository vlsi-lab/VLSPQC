...
#include "LESS_KAT_400_220.h" // Test Vectors
...
int main(void)
{
    ...
    //*************************************************
        ...
        if(memcmp(sm, TVEC_IN_SM_SIGN, 5762)) { printf("ERROR: SM mismatch\n"); }
    ...
    //*************************************************
        ...
        #endif /* TEST_KEY */
        #if TEST_SIGN == 0 
          memcpy(sm, TVEC_IN_SM_SIGN, 5762);
        #endif /* TEST_SIGN */
        
        crypto_sign_open(m1, &mlen1, sm, 5762, pk);
