...
#include "LESS_KAT_252_68.h" // Test Vectors
...
int main(void)
{
    ...
    //*************************************************
        ...
        if(memcmp(sm, TVEC_IN_SM_SIGN, 1778)) { printf("ERROR: SM mismatch\n"); }
    ...
    //*************************************************
        ...
        #endif /* TEST_KEY */
        #if TEST_SIGN == 0 
          memcpy(sm, TVEC_IN_SM_SIGN, 1778);
        #endif /* TEST_SIGN */
        
        crypto_sign_open(m1, &mlen1, sm, 1778, pk);
