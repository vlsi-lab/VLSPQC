...
#include "LESS_KAT_252_192.h" // Test Vectors
...
int main(void)
{
    ...
    //*************************************************
        ...
        if(memcmp(sm, TVEC_IN_SM_SIGN, 2306)) { printf("ERROR: SM mismatch\n"); }
    ...
    //*************************************************
        ...
        #endif /* TEST_KEY */
        #if TEST_SIGN == 0 
          memcpy(sm, TVEC_IN_SM_SIGN, 2306);
        #endif /* TEST_SIGN */
        
        crypto_sign_open(m1, &mlen1, sm, 2306, pk);
