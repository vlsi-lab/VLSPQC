...
#include "LESS_KAT_400_102.h" // Test Vectors
...
int main(void)
{
    ...
    //*************************************************
        ...
        if(memcmp(sm, TVEC_IN_SM_SIGN, 3900)) { printf("ERROR: SM mismatch\n"); }
    ...
    //*************************************************
        ...
        #endif /* TEST_KEY */
        #if TEST_SIGN == 0 
          memcpy(sm, TVEC_IN_SM_SIGN, 3900);
        #endif /* TEST_SIGN */
        
        crypto_sign_open(m1, &mlen1, sm, 3900, pk);
